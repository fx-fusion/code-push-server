...
-- ----------------------------
BEGIN;
INSERT INTO `user_tokens` (`id`, `uid`, `name`, `tokens`, `created_by`, `description`, `is_session`, `expires_at`, `created_at`, `deleted_at`) VALUES (2, 1, 'Login-1721123177850', 'W98hE5uEPtnp5dqjRLwVTeaNA8F54ksvOXqog', 'Login-1721123177850', 'Login-1721123177850', 0, '2024-08-15 17:46:17', '2024-07-16 17:46:17', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `username`, `password`, `email`, `identical`, `ack_code`, `updated_at`, `created_at`) VALUES (1, 'mishu', '$2a$12$LX5ikLRulCbqsCSv8MleRe/fz6YEtV7tr8YBco8zchKjsMf97sFSe', 'mishu@gmail.com', '4ksvOXqog', 'SGU1S', '2024-07-16 17:53:36', '2016-02-29 21:24:49');
COMMIT;
